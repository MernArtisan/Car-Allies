...
@section('description', 'Terms and conditions page for users')
        ...
        <div class="row">
            <div class="col-lg-12 align-self-center">
                <div class="about-us-info-wrap">
                    ...
                    @if($content)
                        <div class="section-title-area ltn__section-title-2">
                            <h6 class="section-subtitle ltn__secondary-color">// Terms and Conditions</h6>
                            <h1 class="section-title">{{ $content->title ?? 'Terms & Conditions' }}<span>.</span></h1>
                        </div>
